...
/* 0x100634B0 BrGlCfgSave, the GLIDE build of the config writer, is filed in
 * src/core/settings/br_cfgfile.c beside the reader of the same file.  The
 * port body below stays here, as br_cfgfile.h records. */
 ...
 * @t3-measure bytes 469/469 insns 124/124 rows 0+0 regions 2 oracle UNVERIFIED
