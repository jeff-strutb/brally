/* @implements 0x10043690 glide FUN_10043690
 * @cpp_kind free
 * @cpp_symbol ?FUN_10043690@@YAHPAVGameUi@@@Z
 *
...
public:
    ...
    short w12;                      /* +0x12 */
    Page043690 *a14[22];              /* +0x14 */
    int a6C[1];                     /* +0x6C */
};

typedef char chk_page043690[sizeof(Page043690) == 0x348 ? 1 : -1];
typedef char chk_ctl043690[sizeof(BrCtl) == 0x1E214 ? 1 : -1];
typedef char chk_w1e20c043690[(unsigned)&((BrCtl *)0)->w1E20C == 0x1E20C ? 1 : -1];
typedef char chk_a6c043690[(unsigned)&((GameUi *)0)->a6C == 0x6C ? 1 : -1];
...
extern "C" {
BrCtl *g_brAA29B0;
int BrPhaseGoto_10047050();
int BrPhaseLeave_10046FD0();
int BrSub10047360();
...
int FUN_10043690(GameUi *parent)
{
    Page043690 *cont;
    BrCtl     *p;
    char       bad;
