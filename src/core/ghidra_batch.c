...
/* Was @t3-certified 2026-09-10 on the byte-argument wall below; byte-exact
 * as a C++ TU on 2026-09-12 (the wall is a BYTE-typed thiscall parameter,
 * which C++ spells as a class method), so the certification is retired. */
