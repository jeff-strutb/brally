/* @implements 0x10043370 glide BrExt_10049F40
 * @cpp_kind free
 * @cpp_symbol ?BrExt_10049F40@@YAHPAVGameUi@@@Z
 *
 * 800 B cdecl EH-frame menu-page builder. Emitted by
...
public:
    ...
    short w12;                      /* +0x12 */
    Page043370 *a14[22];              /* +0x14 */
    int a6C[1];                     /* +0x6C */
};

typedef char chk_page043370[sizeof(Page043370) == 0x348 ? 1 : -1];
typedef char chk_ctl043370[sizeof(BrCtl) == 0x1E214 ? 1 : -1];
typedef char chk_w1e20c043370[(unsigned)&((BrCtl *)0)->w1E20C == 0x1E20C ? 1 : -1];
typedef char chk_a6c043370[(unsigned)&((GameUi *)0)->a6C == 0x6C ? 1 : -1];
...
extern "C" {
BrCtl *g_brAA29B0;
int BrPhaseGoto_10046FC0();
int BrPhaseLeave_10046F60();
int BrSub10047360();
...
int BrExt_10049F40(GameUi *parent)
{
    Page043370 *cont;
    BrCtl     *p;
    char       bad;
    ...
    p->w1E20C = 3;
    p->s34(BrStrGet(0x10), 1, 1, &DAT_100aabd8);
    cont->w14 += 1;
    p = new BrCtl;
    cont->a18[cont->w14] = p;
    bad = (p == 0);
    ...
    p->pfn08 = (CtlFn)BrPhaseLeave_10046F60;
    p->w1E20C = 3;
    p->s34(BrStrGet(0x11), 1, 1, &DAT_100aabe8);
    g_brAA29B0 = p;
    cont->w14 += 1;
    cont->w344 += 1;
    p = new BrCtl;
    ...
    p->pfn0C = (CtlFn)BrSub10047360;
    p->pfn08 = (CtlFn)BrPhaseGoto_10046FC0;
    p->w1E20C = 3;
    p->s34(BrStrGet(0x12), 1, 1, &DAT_100aabe8);
    cont->w14 += 1;
    cont->w344 += 1;
