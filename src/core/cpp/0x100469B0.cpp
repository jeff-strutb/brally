...
/* @implements 0x100469b0 glide FUN_100469b0
 * @cpp_kind free
 * @cpp_symbol ?FUN_100469b0@@YAHPAVGameUi@@@Z
 *
 * 1210 B cdecl EH-frame menu-page builder. Emitted by
...
public:
    ...
    short w12;                      /* +0x12 */
    Page0469B0 *a14[22];              /* +0x14 */
    int a6C[1];                     /* +0x6C */
};

typedef char chk_page0469B0[sizeof(Page0469B0) == 0x348 ? 1 : -1];
typedef char chk_ctl0469B0[sizeof(BrCtl) == 0x1E214 ? 1 : -1];
typedef char chk_sel_off[(unsigned)&((BrCtl *)0)->m3838 == 0x3838 ? 1 : -1];
typedef char chk_f1e1f4[(unsigned)&((BrCtl *)0)->f1E1F4 == 0x1E1F4 ? 1 : -1];
typedef char chk_w1e20c0469B0[(unsigned)&((BrCtl *)0)->w1E20C == 0x1E20C ? 1 : -1];
typedef char chk_a6c0469B0[(unsigned)&((GameUi *)0)->a6C == 0x6C ? 1 : -1];
...
int FUN_100469b0(GameUi *parent)
{
    Page0469B0 *cont;
    BrCtl     *p;
    char       bad;
    ...
    p->w1E20C = 3;
    p->s34(BrStrGet(0x2a), 1, 1, &DAT_100aaca8);
    cont->w14 += 1;
    p = new BrCtl;
    cont->a18[cont->w14] = p;
    bad = (p == 0);
    ...
    p->w1E20C = 3;
    p->s34(BrStrGet(0x2d), 1, 1, &DAT_100aabe8);
    g_AA29C8 = p;
    cont->w14 += 1;
    cont->w344 += 1;
    p = new BrCtl;
