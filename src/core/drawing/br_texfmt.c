 ...
 *
 * The second half arrived from slice2_17.c: 0x1002A9F7's bit-count ladder,
 * 0x100275C0 (the Glide build's own aspect-code routine, the twin of
 * BrTexAspectFromSize above) and the 0x10024DF0 mode map.  slice2_17.c's
 * preamble comes with them -- an include set that looks redundant has
