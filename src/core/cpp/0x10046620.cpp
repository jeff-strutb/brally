/* @implements 0x10046620 glide FUN_10046620
 * @cpp_kind free
 * @cpp_symbol ?FUN_10046620@@YAHPAVGameUi@@@Z
 *
 * 908 B cdecl EH-frame menu-page builder. Emitted by
...
public:
    ...
    short w12;                      /* +0x12 */
    Page046620 *a14[22];              /* +0x14 */
    int a6C[1];                     /* +0x6C */
};

typedef char chk_page046620[sizeof(Page046620) == 0x348 ? 1 : -1];
typedef char chk_ctl046620[sizeof(BrCtl) == 0x1E214 ? 1 : -1];
typedef char chk_w1e20c046620[(unsigned)&((BrCtl *)0)->w1E20C == 0x1E20C ? 1 : -1];
typedef char chk_a6c046620[(unsigned)&((GameUi *)0)->a6C == 0x6C ? 1 : -1];
...
int FUN_10046620(GameUi *parent)
{
    Page046620 *cont;
    BrCtl     *p;
    char       bad;
    ...
    p->w1E20C = 3;
    p->s34(BrStrGet(0x20), 1, 1, &DAT_100aaca8);
    cont->w14 += 1;
    p = new BrCtl;
    cont->a18[cont->w14] = p;
    bad = (p == 0);
    ...
    p->w1E20C = 3;
    p->s34(BrStrGet(0x2a), 1, 1, &DAT_100aabe8);
    cont->w14 += 1;
    cont->w344 += 1;
    p = new BrCtl;
    cont->a18[cont->w14] = p;
