...
typedef char chk_p2AE8[(unsigned)&((Ctl400E0 *)0)->p2AE8 == 0x2AE8 ? 1 : -1];

extern "C" {
Phase400E0 *g_brPhase5C5C;      /* 0x10AC5C5C -- current phase */
Phase400E0 *g_brRoot5C60;       /* 0x10AC5C60 -- root phase */
int         g_brPending5C74;    /* 0x10AC5C74 */
}
