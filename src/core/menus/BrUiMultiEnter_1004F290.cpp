...
typedef char chk_page04F290[sizeof(Page04F290) == 0x348 ? 1 : -1];
typedef char chk_ctl04F290[sizeof(BrCtl) == 0x1E214 ? 1 : -1];
typedef char chk_sel_off[(unsigned)&((BrCtl *)0)->m3838 == 0x3838 ? 1 : -1];
typedef char chk_f1e1f4[(unsigned)&((BrCtl *)0)->f1E1F4 == 0x1E1F4 ? 1 : -1];
typedef char chk_w1e20c04F290[(unsigned)&((BrCtl *)0)->w1E20C == 0x1E20C ? 1 : -1];
typedef char chk_a6c04F290[(unsigned)&((GameUi *)0)->a6C == 0x6C ? 1 : -1];
...
int BrUiMultiEnter_1004F290(GameUi *parent)
{
    ...
    p->w1E20C = 3;
    p->s34(BrStrGet(0x5c), 1, 1, &DAT_100aaca8);
    cont->w14 += 1;
    p = new BrCtl;
    cont->a18[cont->w14] = p;
    bad = (p == 0);
    ...
    p->w1E20C = 0x34;
    p->s34(BrStrGet(0x3c), 1, 4, &DAT_100aabe8);
    cont->w14 += 1;
    p = new BrCtl;
    cont->a18[cont->w14] = p;
    bad = (p == 0);
    ...
    p->pfn08 = (CtlFn)BrToggleOnce_BFF0;
