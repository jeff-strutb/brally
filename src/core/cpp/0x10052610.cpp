/* @implements 0x10052610 glide BrExt_10059760
 * @cpp_kind free
 * @cpp_symbol ?BrExt_10059760@@YAHPAVGameUi@@@Z
 *
 * 1091 B cdecl EH-frame menu-page builder. Emitted by
...
public:
    ...
    short w12;                      /* +0x12 */
    Page052610 *a14[22];              /* +0x14 */
    int a6C[1];                     /* +0x6C */
};

typedef char chk_page052610[sizeof(Page052610) == 0x348 ? 1 : -1];
typedef char chk_ctl052610[sizeof(BrCtl) == 0x1E214 ? 1 : -1];
typedef char chk_sel_off[(unsigned)&((BrCtl *)0)->m3838 == 0x3838 ? 1 : -1];
typedef char chk_f1e1f4[(unsigned)&((BrCtl *)0)->f1E1F4 == 0x1E1F4 ? 1 : -1];
typedef char chk_w1e20c052610[(unsigned)&((BrCtl *)0)->w1E20C == 0x1E20C ? 1 : -1];
typedef char chk_a6c052610[(unsigned)&((GameUi *)0)->a6C == 0x6C ? 1 : -1];
typedef char chk_tbl052610[(unsigned)&((Root052610 *)0)->pTable == 0xC0 ? 1 : -1];

typedef int (*CtlFn)(BrCtl *);

extern "C" {
int BrPhaseActivate_10044D00();
int BrPhaseActivate_10046260();
int BrPhaseLeave_10044C70();
int BrSub10047360();
...
int BrExt_10059760(GameUi *parent)
{
    Page052610 *cont;
    BrCtl     *p;
    char       bad;
    ...
    p->w1E20C = 3;
    p->s34(BrStrGet(0x6a), 1, 1, &DAT_100aaca8);
    cont->w14 += 1;
    p = new BrCtl;
    cont->a18[cont->w14] = p;
    bad = (p == 0);
    ...
    p->w1E20C = 3;
    p->s34(BrStrGet(0x6b), 1, 1, &DAT_100aabe8);
    cont->w14 += 1;
    cont->w344 += 1;
    p = new BrCtl;
    cont->a18[cont->w14] = p;
    ...
    p->w1E20C = 3;
    p->s34(BrStrGet(0x6c), 1, 1, &DAT_100aabe8);
    cont->w14 += 1;
    cont->w344 += 1;
    p = new BrCtl;
    cont->a18[cont->w14] = p;
    ...
    if (bad)
        FUN_100378c0(4);
    p->s38(parent, 80.0f, 46.0f, 9, 2, 5, 0, 8);
    cont->w14 += 1;
