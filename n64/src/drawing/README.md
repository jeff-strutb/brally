...
Confirmed in the Top Gear Rally ROM: **15 functions, 848 bytes (0.19% of the 457,392-byte `.text`)**, of which **1 are byte-exact**.

The source that produced these is shared with the PC decomp and lives in:

  - `src/core/drawing/br_dlcmd.c`
  - `src/core/drawing/br_dlglide.c`
  - `src/core/drawing/br_font.c`
  - `src/core/drawing/br_gbitexscan.c`
  - `src/core/drawing/br_img.c`
  - `src/core/drawing/br_imgblit.c`
  - `src/core/drawing/br_surf.c`
