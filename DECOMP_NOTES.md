# Decomp notes (archive)

This is the previous README, kept verbatim for the hard-won detail in it:
the gotcha tables, adjudicated conflicts, format reversing, function-map
errata, and the running commentary on coverage measurement. Some sections are
stale; the root [README.md](README.md) is the current status of record.
