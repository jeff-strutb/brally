 ...
 * this one clears its buffer and runs a preparation step before opening. */
/* @implements 0x1003D140 glide Ctl3D140
 * @cpp_kind method
 * @cpp_symbol ?Activate@Ctl3D140@@QAEHXZ
 *
