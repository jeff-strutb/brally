 ...
 *
 * The .rca texture-record fixup that followed the fade in the address batch
 * lives in gamedata/br_carload.c.
 *
...
/* 0x10018D50 BrRcaSwapMesh and 0x10018B60 BrRcaFixupRecord (the .rca
 * texture-record fixup) live in gamedata/br_carload.c. */
