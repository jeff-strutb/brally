...
extern "C" {
Phase3E1C0 *g_brPhase5C5C;      /* 0x10AC5C5C -- current phase */
Phase3E1C0 *g_brNext5C60;       /* 0x10AC5C60 -- root phase */
int         g_brPending5CB4;    /* 0x10AC5CB4 */
}
