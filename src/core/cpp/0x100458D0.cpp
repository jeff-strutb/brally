...
/* @implements 0x100458D0 glide BrPhaseEnterPlaceholder_1004C4A0
 * @cpp_kind free
 * @cpp_symbol ?BrPhaseEnterPlaceholder_1004C4A0@@YAHPAVGameUi@@@Z
 *
 * 1565 B cdecl EH-frame menu-page builder, same family as 0x10048160 and
 * 0x100425E0: `new Page458D0` (0x348, ctor 0x10048470) then nine
...
public:
    ...
    short w12;                      /* +0x12 */
    Page458D0 *a14[22];              /* +0x14 */
    int a6C[1];                     /* +0x6C */
};

typedef char chk_page458D0[sizeof(Page458D0) == 0x348 ? 1 : -1];
typedef char chk_ctl458D0[sizeof(BrCtl) == 0x1E214 ? 1 : -1];
typedef char chk_w1e20c458D0[(unsigned)&((BrCtl *)0)->w1E20C == 0x1E20C ? 1 : -1];
typedef char chk_a6c458D0[(unsigned)&((GameUi *)0)->a6C == 0x6C ? 1 : -1];
...
int BrPhaseEnterPlaceholder_1004C4A0(GameUi *parent)
{
    Page458D0 *cont;
    BrCtl     *p;
    char       bad;
    ...
    p->w1E20C = 3;
    p->s34(BrStrGet(0x1F), 1, 1, &DAT_100aaca8);
    cont->w14 += 1;
    ...
    p->w1E20C = 3;
    p->s34(BrStrGet(0x23), 1, 1, &DAT_100aabe8);
    cont->w14 += 1;
    cont->w344 += 1;
    ...
    p->w1E20C = 3;
    p->s34(BrStrGet(0x24), 1, 1, &DAT_100aabe8);
    cont->w14 += 1;
    cont->w344 += 1;
    ...
    p->w1E20C = 3;
    p->s34(BrStrGet(0x25), 1, 1, &DAT_100aabe8);
    cont->w14 += 1;
    cont->w344 += 1;
